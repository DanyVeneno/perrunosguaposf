...
<template>
  <div v-if="validToken">
    <h1 class="text-6xl font-extrabold text-purple-100 text-center mt-10">
      Nuevo Password
    </h1>
    <p class="text-2xl text-purple-100 text-center my-5">
  ...
  <p v-else class="text-center text-2xl font-black text-purple-100">
    Token no válido
  </p>
</template>
