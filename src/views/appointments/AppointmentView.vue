...
<template>
  <h2 class="text-4xl font-extrabold text-purple-100">
  ...
  <h3 class="text-3xl font-extrabold text-purple-100">Servicios</h3>

  <p
    v-if="appointments.noServicesSelected"
    class="text-purple-100 text-2xl text-center"
  >
  ...
  <div v-else class="grid gap-5">
    ...
    <p class="text-right text-purple-100 text-2xl">
      Total a pagar:
  ...
  <div class="space-y-8" v-if="!appointments.noServicesSelected">
    <h3 class="text-3xl font-extrabold text-purple-100">Fecha y Hora</h3>

    <div class="lg:flex gap-5 items-start">
      <div class="w-full lg:w-96 bg-purple-400 flex justify-center rounded-lg">
      ...
      >
        <button
          ...
          class="block text-purple-100 rounded-lg text-xl font-black p-3 disabled:opacity-10"
          :class="
    ...
    <div v-if="appointments.isValidReservation" class="flex justify-end">
      <button
        class="w-full md:w-auto bg-purple-500 p-3 rounded-lg uppercase font-black text-purple-100"
